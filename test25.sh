...
python3 -m verl.trainer.main_ppo --config-path=/mnt/share/w00914260/veomni-verl-main/huazhong/verl/verl/trainer/config/ \
    ...
    data.train_files=/mnt/share/nurxat/gptoss/data/gsm8k/train.parquet \
    data.val_files=/mnt/share/nurxat/gptoss/data/gsm8k/test.parquet \
    ...
    actor_rollout_ref.model.path=/mnt/share/w00914260/others/wsy_verl_qianyi/Qwen2.5-0.5B-Instruct \
